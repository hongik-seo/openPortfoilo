...
<div id="bookAllWrap">
		...
		<form  action="/nanam/book/updateBookMain" method="get" >
			...
			<div>
				...
				<input name="ISBN" value="${book.ISBN }" readonly/>
				...
				<div  class="caption">
					...
					<textarea id="content" name="bookContent" class="write" cols="40" placeholder=${book.bookContent }
						rows="8"></textarea>
						
					<p>목차 </p>
					<textarea id="content" name="bookIndex" class="write" cols="40" 	 placeholder=${book.bookIndex }
						rows="8"></textarea>	
					<p>저자소개 </p>
					<textarea id="content" name="bookAuthorIntroduce" class="write" cols="40"   placeholder=${book.bookAuthorIntroduce }
						rows="8"></textarea>	
