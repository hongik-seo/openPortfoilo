...
<script>
    ...
    function check() {//체크 매소드 선언
        ...
        var list = document.getElementsByName("list")[0].checked;
        if (list) {
            allChecked = true;
        }
	...
	function resetPage(){
		...
		//return location.href="../main/Index.jsp"
    ...
    function goNextPage(){
    var forceList1 = document.getElementsByName("list")[1].checked;//클래스를 통한 배열 변수 선언  
    var forceList2 = document.getElementsByName("list")[2].checked;//클래스를 통한 배열 변수 선언

    //전체 해제 return ""

 	
        if ((forceList1 && forceList2)==true) {
        	alert("정보입력 페이지로 이동합니다.")
           return location.href="/nanam/member/joinFront";
        }else if((forceList1 && forceList2)==false) {
        	
        	alert("필수항목은 모두 동의하셔야 합니다.")
                ...
                <div id="myFormWrap">
                    ...
                    <form id="myForm" name="myForm" method="get" action="#">
                        ...
                        <ul id="conditionsWrap">
                            ...
                            <!--전체동의-->
                            <li class="itemBox">
                                <input type="checkbox" name="list" id="acceptAll" onclick="check();">
                            ...
                            <li class="itemBox">
                                ...
                                <input type="checkbox" name="list" id="acceptUser">
    
                                <label for="acceptUser">
                                    회원가입 약관(필수)
                                </label>
                            ...
                            <!--개인정보 수집 이용 동의-->
                            <li class="itemBox">
                                <input type="checkbox" name="list" id="acceptPrivate">
                                <label for="acceptPrivate">
                                    개인정보 수집 이용 동의 (필수)
                                </label>
                        ...
                        <ul id="btnWrap">
                            <!--취소버튼-->
                            <li id="leftBtn">
                                <a class="resetBtn" href="#" id="reset" title="취소" role="button"
                                    onclick="location.href=resetPage();">취소</a>
                            ...
                            <!--확인버튼-->
                            <li id="rightBtn">
                                <a class="submitBtn" id="submit" title="가입" role="button"
                                   href="#" onclick="location.href=goNextPage();">확인
                                </a>
                            </li>
