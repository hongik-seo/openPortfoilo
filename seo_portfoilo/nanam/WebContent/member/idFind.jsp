...
<div id="allWrap">
	...
	<div id="goFindWrap">
		<ul>
			<li>로그인하기</li>
			<li style="background-color: #00c5aa;">아이디찾기</li>
			<li>비밀번호찾기</li>
		</ul>
	</div>
	<!--//찾기-->
	...
	<div id="allFindLoginWrap">
		...
		<form id="allFindLoginForm" action="/nanam/member/idFindMain" name="testForm"
			method="post" >
			 -->
			...
			<!--아이디 찾기 버튼-->
			<input type="submit" id="searchBtn" value="아이디 찾기" >
			<div id="callback"></div>
	   </form> 
		<ul>
